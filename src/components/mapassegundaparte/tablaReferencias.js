...
import "./MapaConCapas.css"; // Asegurate de crear este archivo con los estilos
...
const referencias = [
  ...
  { color: "#6d4692", texto: "AI1 - Área inferior - Densidad media baja" },
  { color: "#bda7d3", texto: "AI2 - Área inferior - Densidad baja" },
  { color: "#d64ebd", texto: "AI3 - Área inferior de densidad media baja" },
  { color: "#40a7e9", texto: "AIE - Área inferior Especial - Densidad alta" },
  ...
  { color: "#95acd1", texto: "PIT - Parque Industrial Tecnológico - FASE 1, 2 y 3" },
  { color: "#c85b01", texto: "PLC - Planta de Líquidos Cloacales" },
  { color: "#f1a465", texto: "PLC - Zona Fuelle" },
  { color: "#bfe3b1", texto: "ZPA - Zona de Protección Ambiental - Santa Catalina" }
];
    ...
    <div className="cuadro-referencias">
      {referencias.map((ref, index) => (
        <div className="item-referencia" key={index}>
          <div className="color-box" style={{ background: ref.color }}></div>
          {ref.texto}
        </div>
      ))}
    </div>
