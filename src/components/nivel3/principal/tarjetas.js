            ...
            >
              ...
              <Button
                ...
                sx={{
                  ...
                  color: "#fff",
                  background:
                    "linear-gradient(90deg, #2b8d9c 0%, #1aa0a5 100%)",
                  boxShadow: "0 8px 18px rgba(13, 141, 141, 0.25)",
                  "&:hover": {
                    background:
                      "linear-gradient(90deg, #257c89 0%, #148d8d 100%)",
                  },
                }}
              >
                Modificar
            ...
            >
              ...
              <Box>
                ...
                <Typography sx={sectionSubSx}>
                  Conversión expresada en salarios mínimos y en pesos
                </Typography>
              </Box>
            </Box>
            ...
            >
              <Box
                sx={{
                  ...
                  height: 46,
                  borderRadius: "14px",
                  background: alpha("#0b4f6c", 0.12),
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                <TrendingUpRoundedIcon sx={{ color: "#0b4f6c" }} />
              </Box>

              <Box>
                <Typography sx={sectionTitleSx}>ICC</Typography>
                <Typography sx={sectionSubSx}>
            ...
            <CardContent sx={{ p: 3 }}>
              <Box
                sx={{
                  ...
                  borderRadius: "20px",
                  background:
                    "linear-gradient(135deg, rgba(20,141,141,0.10) 0%, rgba(11,79,108,0.06) 100%)",
                  border: `1px solid ${alpha("#148d8d", 0.12)}`,
                }}
              >
                <Typography
                ...
                <Divider sx={{ my: 2, borderColor: alpha("#0b4f6c", 0.08) }} />
